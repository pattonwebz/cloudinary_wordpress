...
class Test_Api extends \WP_UnitTestCase {
	...
	public function setUp() {
		...
		$this->api = new Api( $this->plugin->components['connect'] );
	}
	...
	public function test_cloudinary_url() {
		$tests = array(
			...
			array(
				'expect'        => 'https://res.cloudinary.com/cloud-folder/image/upload/c_fill,w_100,h_100/a_45/f_webp,q_auto/v1234567/wpfolder/2008/09/image-test.jpg',
			...
			array(
				'expect'        => 'https://res.cloudinary.com/cloud-folder/image/upload/a_45/f_webp,q_auto/$wpsize_!thumbnail!/v1234567/wpfolder/2008/09/image-test.jpg',
				'cloudinary_id' => 'wpfolder/2008/09/image-test.jpg',
				'options'       => array(
					'version'        => '1234567',
					'transformation' => array(
			...
			array(
				'expect'        => 'https://res.cloudinary.com/cloud-folder/image/upload/a_45/f_webp,q_auto/v1234567/wpfolder/2008/09/image-test.jpg',
				'cloudinary_id' => 'wpfolder/2008/09/image-test.jpg',
				'clean'         => true,
				'size'          => array(
					'wpsize' => 'thumbnail',
	...
	public function test_url() {
		$tests = array(
			...
			array(
				'expect'   => 'res.cloudinary.com/cloud-folder/image/upload',
				'resource' => 'image',
				'function' => 'upload',
				'endpoint' => false,
			),
	...
	public function test_upload() {
		...
		$file   = WP_TESTS_DIR . '/data/images/canola.jpg';
		$result = $this->api->upload_large( $file, $args );
		...
		$this->assertArrayHasKey( 'X-Unique-Upload-Id', $result['args']['headers'] );
	}
	...
	public function test_context() {
		...
		$result = $this->api->context( null, $args );
