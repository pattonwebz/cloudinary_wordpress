	...
	'fields'         => array(
		...
		'image_freeform'     => array(
			...
			'description'       => sprintf(
				...
				__( 'The set of transformations to apply to all image assets, as a URL transformation string. %1$sImage transformation reference%2$s.%3$s<span class="settings-alert settings-alert-warning"><strong>Note</strong>: When updating transformations, all relevant assets will have new transformations applied; This may cause an increase in your Cloudinary usage.</span>', 'cloudinary' ),
